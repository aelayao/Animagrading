...
obsAuth(async (user) => {
    ...
    .then(async (docSnap)=>{
      if (docSnap.exists()){
        ...
        const imagenLink = userData.photoURL || userData.photoUrl || user.photoURL || '/general/imagen/user_basic.png';
      ...
      else
      {
        ...
        document.getElementById('usrImg').src = '/general/imagen/user_basic.png';
      }
    })
    .catch((error)=>{
      console.log(error);
